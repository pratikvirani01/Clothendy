      ...
      <div className="aboutTitle">
        ...
        <section className="about-container">
          <div className="about-content">
            <p>
              This website www.clothendy.com is operated by Clothendy.
              Throughout the site, the terms “we”, “us” and “our” refer to
              Clothendy. Clothendy, owned by Bhargav Rangani, offers this
            ...
            <p>
              ...
              affect these Terms. You will receive a password and account
              designation upon completing the Website’s registration process.
              ...
              Immediately notify clothendy.com of any unauthorised use of your
              password or account or any other breach of security (b) Ensure
              that you exit from your account at the end of each session. We
              cannot and will not be liable for any loss or damage arising from
              your failure to comply with this section. We are not responsible
            ...
            <h2>COMMUNICATIONS BY US:</h2>

            <p>
              {" "}
              As a condition of creating an account with us, you consent to us
              sending you:
            </p>
            ...
            <p>
              ...
              monitor’s display of any color will be accurate. If the quality of
              any products, services, information, or other material purchased
              or obtained by you through the Website did not meet your
              expectations, no compensation will be given other than Exchange of
              the product..
            </p>
            ...
            <p>
              ...
              expressly mentioned, Clothendy owns all Intellectual Property
              Rights to and into the Website, including, without limitation, any
              and all rights, title and interest in and to copyright, related
              rights, patents, utility models, trademarks, trade names, service
              marks, designs, know-how, trade secrets and inventions (whether
              patentable or not), goodwill, source code, meta tags, databases,
              text, content, graphics, icons, and hyperlinks. You acknowledge
              and agree that you shall not use, reproduce or distribute any
              content from the Website belonging to us without obtaining prior
              authorisation. The compilation (meaning the collection,
              arrangement and assembly) of all content on this Site is the
              exclusive property of Clothendy and protected by international
              copyright laws. All software used on this website is the exclusive
              property of Clothendy and protected by international copyright
              laws. The Content and software on this website may be used as a
              shopping resource. Any other use, including the reproduction,
              modification, distribution, transmission, republication, display,
              or performance of the content of this website is strictly
              prohibited.
            </p>
            ...
            <p>
              ...
              Services may change at our discretion. In accordance with our
              guidelines, prices might change when the stocks are replenished.
              Despite our best efforts, a small number of the items in our
              catalogue may be mispriced. However, we verify prices as part of
              our dispatch procedures. If an item’s correct price is lower than
              our stated price, we charge the lower amount and send you the
              item. If a product’s correct price is higher than our stated
              price, we will notify you of the same and request confirmation to
              proceed or cancel such order.
            </p>

            <h2>INDEMNIFICATION</h2>
            <p>
              You agree to indemnify, defend and hold harmless Clothendy and our
            ...
            <p>
              ...
              breached any of the Terms. If you or Clothendy terminates your use
              of the Website or any Service, we may delete any content or other
              materials relating to your use of the Service and we will have no
              liability to you or any third party for doing so. You shall be
              liable to pay for any Service or product that you have already
            ...
            <p>
              ...
              Terms and Conditions or the right to use the Website by you
              contained herein or any other section or pages of the Website or
            ...
            <p>
              ...
              material or content uploaded on to the Website. We do not review
              the contents in any way before they appear on the Website. We do
              not verify, endorse or otherwise vouch for the contents of any
              ...
              violation of these Terms, please report to clothendy@gmail.com.
            </p>

            <p>
              Process for Pilferage Claim: If a customer raises a complaint for
            ...
            <p>
              ...
              information about the case B. Customer fails to provide snapshots
              of the packet and box (if any) C. If an opened delivery was
            ...
            <p> Questions about the Terms of Service should be sent to us at clothendy@gmail.com</p>
          </div>
        </section>
      </div>
      <Footer />
